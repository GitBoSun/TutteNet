...
def eval_setup(
    ...
    config.pipeline.model.keep_shape = keep_shape 
    config.pipeline.model.shape_path = shape_path 
    if add_deformation: 
        config.pipeline.model.add_deformation = True 
        if tutte_learning_path != "":
            config.pipeline.model.tutte_learning_path = tutte_learning_path 
            config.pipeline.model.build_learning = True 
            config.pipeline.model.shape_name = shape_name 
        elif tutte_deform_path != "":
            config.pipeline.model.tutte_deform_path = tutte_deform_path 
            config.pipeline.model.build_tutte = True 
            config.pipeline.model.shape_name = shape_name 
